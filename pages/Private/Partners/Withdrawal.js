    ...
    return (
        <>
            <div className=" p-2 w-full">
                ...
                {/* return  a type of partners Withdrawal */}
                <FilterCategory />

                {/* Select a date range of partner Withdrawal made */}
    ...
    return (
        <>
            <div className="flex  items-center w-full mb-2">
                ...
                <div className="category-btn bg-red-500 mr-1 px-20">금일 환전금액  : {WebHelper.FormatMoney(512100)}원</div>
            </div>
        </>
    )
});
